/**
 * Vercel Cron Job: Сбор Telegram постов
 * Запускается 1 раз в сутки (в 07:00 по UTC)
 *
 * Использует парсинг HTML через t.me/s/username
 * Не требует API ключей, полностью бесплатно
 */
...
export default async function handler(
    ...
    try {
        // Вызываем Edge Function для сбора Telegram постов
        ...
        console.error('Error in fetch-telegram cron:', error);
