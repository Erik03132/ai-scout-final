...
2. В поле "mentions" ОБЯЗАТЕЛЬНО извлеки ТОЛЬКО названия нейросетей, языковых моделей (LLM) и AI-сервисов (например: ChatGPT, Claude, Midjourney, Kimi, Perplexity, OpenAI, Anthropic и т.д.). СТРОГО ИГНОРИРУЙ обычные инструменты разработчиков, языки программирования и фреймворки (типа React, Python, Go, Next.js, Vite, Tailwind, Node.js). Нас интересует только AI!
