...
1. "mentions" - массив ТОЛЬКО AI-инструментов, нейросетей, LLM и специализированных AI-сервисов (например: ChatGPT, Claude, Vercel v0, Cursor, Kimi, Perplexity). СТРОГО ЗАПРЕЩЕНО писать обычные языки программирования и веб-фреймворки (НЕ ПИШИ React, Python, Go, Java, Next.js, FastAPI, Node.js, HTML, CSS и т.д.).
